...
import org.pk.cas.fastfood1.MainActivity;
...
public class PizzaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        progressBar_Pizza =view.findViewById(R.id.progress_Bar_Pizza);
        ...
        db.collection("Pizza").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                for (DocumentSnapshot d:fetchingInDataFromFireStore){
                    ...
                    dataList1.add(obj1);
                    progressBar_Pizza.setVisibility(View.GONE);
