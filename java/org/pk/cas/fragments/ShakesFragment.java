...
public class ShakesFragment extends Fragment {
    ...
    ProgressBar progressBar_Shakes;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        progressBar_Shakes = view.findViewById(R.id.progress_Bar_Shakes);
        FirebaseFirestore db =FirebaseFirestore.getInstance();
        recyclerView =view.findViewById(R.id.Shake_RecyclerView);
        ...
        db.collection("Shake").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                for (DocumentSnapshot d:fetchingInDataFromFireStore){
                    ...
                    dataList1.add(obj1);
                    progressBar_Shakes.setVisibility(View.GONE);
